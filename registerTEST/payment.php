...
<body>
        ...
        <div class="container center-block" style="text-align:center;">
          ...
          <p style="color:steelblue; font-size:12pt;">Empower Team will contact you soon for the confirmation. <br>
			 Kindly proceed with the payment through below mentioned options. 	
            </p>
		  
		  <!--<p>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/general-full-workshop-registration/'" id="gen_full" class="btn btn-warning center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/differently-abled-full-workshop-registration/'" id="da_full" class="btn btn-warning center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/student-full-workshop-registration-2/'" id="student_full" class="btn btn-warning center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/accompanying-person-full-workshop-registration/'" id="ap_full" class="btn btn-warning center-block" style="display:none;">Make Payment</button>
		  
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/general-one-day-registration/'" id="gen_one" class="btn btn-primary center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/differently-abled-one-day-registration/'" id="da_one" class="btn btn-primary center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/studentone-day-registration/'" id="student_one" class="btn btn-primary center-block" style="display:none;">Make Payment</button>
		  <button type="button" onclick="location.href='https://fitt-iitd.in/booking/accompanying-personfull-workshop-registration/'" id="ap_one" class="btn btn-primary center-block" style="display:none;">Make Payment</button>
		  
		  <span style="color:red; font-size:10pt; margin-top:15px;"><em>You will be redirected to FIIT-IITD Website for payment</em></span>
<script>
	...
	var abc = '<?php echo $del ?>';
        ...
        <div class="container">
        	<p style="margin-bottom:0px;"><strong>PAYMENT OPTIONS:</strong></p>
                        ...
                        <div class="panel-group" id="accordion8" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="collapseOne8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne8">
                                    <div class="panel-body">
                                        ...
                                        <p>
											...
											Name of the Beneficiary : FITT, IIT Delhi</br>
										...
										<p>
											...
											Beneficiary : Foundation for Innovation and Technology Transfer</br>
							...
							<div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingThree8">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion8" href="#collapseThree8" aria-expanded="false" aria-controls="collapseTwo8">
                                            Payment Gateway <span style="font-size:9pt; color:#F00;"> *Coming Up Soon</span>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseThree8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                    <p>You can pay directly by Payment Gateway, which opens on 15 September 2018</p>
                                    </div>
                                </div>
                            </div>
            ...
            <p class="lead" style="color:darkgreen; font-size:12pt;"><strong>Please check your email</strong><br>
            <span style="color:#000;">Confirmation is subject to reconciliation of payment.</span>
        <p>
          ...
          <p style="margin-top:50px; text-align:center; font-size:10pt; color:#333; border-top:1px solid #CCC; padding:10px 0 0 0;">
          Privacy Policy . Refund Policy . All Rights Reserved
          </p>
